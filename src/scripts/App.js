        ...
        <div className="mdl-layout mdl-js-layout mdl-layout--fixed-header">
          <header className="mdl-layout__header">
            <div className="mdl-layout__header-row">
              <span className="mdl-layout-title">Tools PWA</span>
              <div className="mdl-layout-spacer"></div>
              <div className="mdl-textfield--floating-label mdl-textfield--align-right">
                <button id="butRefresh" className="mdl-button mdl-js-button mdl-button--icon"
                      htmlFor="fixed-header-drawer-exp" aria-label="Refresh" > 
          ...
          <div className="mdl-layout__drawer">
            ...
            <nav className="mdl-navigation">
              <a className="mdl-navigation__link" href="">Weather</a>
